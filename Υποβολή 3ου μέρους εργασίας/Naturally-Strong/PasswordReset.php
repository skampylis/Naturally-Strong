...
// Include Reset Handler
require "includes\\form_handlers\passwordReset_handler.php";
?>
...
<body>
    <div class="wrapper">
        ...
        <div class="form-group">
                <label>Email</label>
                <input type="email" name="email" class="form-control <?php echo (!empty($email)) ? 'is-invalid' : ''; ?>" value="<?php echo $email; ?>" required>
